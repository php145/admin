  ...
  <div>
    ...
    <el-table
      ...
      <el-table-column
          ...
          label="角色名称">
        <template slot-scope="scope">
          <el-tag size="small" type="info" v-for="item in scope.row.sysRoles" v-bind:key="item.name">{{
              item.name
            }}
          </el-tag>
        </template>
...
export default {
  ...
  methods: {
    ...
    delHandle(id) {
      ...
      this.$axios.post("/sys/user/delete", ids).then(() => {
        this.$message({
          showClose: true,
          message: '恭喜你，操作成功',
          type: 'success',
    ...
    submitRoleHandle() {
      ...
      this.$axios.post('/sys/user/role/' + this.roleForm.id, roleIds).then(() => {
        this.$message({
          showClose: true,
          message: '恭喜你，操作成功',
          type: 'success',
    ...
    repassHandle(id, username) {
      ...
      this.$confirm('将重置用户【' + username + '】的密码, 是否继续?', '提示', {
        ...
        this.$axios.post("/sys/user/repass", id).then(() => {
          this.$message({
            showClose: true,
            message: '恭喜你，操作成功',
            type: 'success',
